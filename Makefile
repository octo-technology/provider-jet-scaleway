...
PROJECT_NAME := provider-jet-scaleway
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-scaleway/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-scaleway_v$(TERRAFORM_PROVIDER_VERSION)_x5
...
IMAGES = provider-jet-scaleway provider-jet-scaleway-controller
